      ...
      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {accessDenied && (
            <div className="mb-5 p-4 bg-red-50 border border-red-100 rounded-xl text-center">
              ...
              <p className="text-xs text-red-500">
                Your account has not been invited. Contact your administrator.
              </p>
            </div>
          )}
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 font-medium py-3 px-4 rounded-xl hover:bg-gray-50 hover:border-gray-400 transition-all shadow-sm disabled:opacity-60"
          >
            {loading ? (
        ...
        <p className="text-xs text-center text-gray-400 mt-4">
          © {new Date().getFullYear()} 5DM Africa · BandaBets
        </p>
      </div>
    </div>
  )

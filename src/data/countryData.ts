...
export const countrySummaryGSC = {
  Nigeria: {
    totalClicks:       nigeriaGSC.reduce((s,d)=>s+d.clicks,0),
    totalImpressions:  nigeriaGSC.reduce((s,d)=>s+d.impressions,0),
    avgCtr:            4.38,
    avgPosition:       13.2,
    clicksChange:      +18.2,
  ...
  Kenya: {
    totalClicks:       kenyaGSC.reduce((s,d)=>s+d.clicks,0),
    totalImpressions:  kenyaGSC.reduce((s,d)=>s+d.impressions,0),
    avgCtr:            4.19,
    avgPosition:       13.9,
    clicksChange:      +12.4,
  ...
  Uganda: {
    totalClicks:       ugandaGSC.reduce((s,d)=>s+d.clicks,0),
    totalImpressions:  ugandaGSC.reduce((s,d)=>s+d.impressions,0),
    avgCtr:            4.12,
    avgPosition:       14.5,
    clicksChange:      +28.6,
  ...
  Congo: {
    totalClicks:       congoGSC.reduce((s,d)=>s+d.clicks,0),
    totalImpressions:  congoGSC.reduce((s,d)=>s+d.impressions,0),
    avgCtr:            3.84,
    avgPosition:       15.2,
    clicksChange:      +21.2,
    impressionsChange: +17.8,
    ctrChange:         +2.8,
    positionChange:    -2.1,
  },
}
...
export const countrySummaryGA4 = {
  Nigeria: {
    ...
    newUsers:           nigeriaGA4.reduce((s,d)=>s+d.newUsers,0),
  ...
  Kenya: {
    ...
    newUsers:           kenyaGA4.reduce((s,d)=>s+d.newUsers,0),
  ...
  Uganda: {
    ...
    newUsers:           ugandaGA4.reduce((s,d)=>s+d.newUsers,0),
  ...
  Congo: {
    ...
    newUsers:           congoGA4.reduce((s,d)=>s+d.newUsers,0),
